"""Crea tabla REALTIME fact_partner_ledger (ventas → fee → saldo publisher)."""
import json
import os
import sys
import time
...
if __name__ == "__main__":
    print("=" * 55)
    print("  GameMetrics — fact_partner_ledger (dinero por venta)")
    print("=" * 55)
    for _ in range(20):
        try:
    ...
    if not setup_table(TABLE):
        sys.exit(1)
    print("\nOK: fact_partner_ledger lista")
