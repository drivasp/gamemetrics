"""Crea tablas Pinot: fact_audit_log, market_listings, market_transactions, market_items."""
import json
import os
import sys
import time
...
TABLES = ["fact_audit_log", "market_listings", "market_transactions", "market_items"]
...
if __name__ == "__main__":
    print("=" * 55)
    print("  GameMetrics — audit + marketplace tables")
    print("=" * 55)
    for _ in range(20):
        try:
